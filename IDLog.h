...
#define IDLogError(fmt,...) 		IDLog(IDLogTypeError,fmt,...)
#define IDLogWarning(fmt,...) 	IDLog(IDLogTypeWarning,fmt,...)
#define IDLogDebug(fmt,...) 		IDLog(IDLogTypeDebug,fmt,...)
#define IDLogInfo(fmt,...) 			IDLog(IDLogTypeInfo,fmt,...)
